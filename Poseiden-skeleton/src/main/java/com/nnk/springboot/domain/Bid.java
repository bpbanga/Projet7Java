 ...
 */
    ...
    public Bid(Integer bidListId, @NotBlank(message = "Account is mandatory") String account,
            @NotBlank(message = "Type is mandatory") String type, Double bidQuantity, Double askQuantity, Double bid,
            Double ask, Timestamp bidListDate, String commentary, String security, String status, String trader,
